...
# host="0.0.0.0" makes it bind all interfaces (needed on a cloud host;
# fine to leave as default 127.0.0.1 if you'll reach it via a local tunnel).
mcp = FastMCP("danbooru-tags", host="127.0.0.1", port=8000)
